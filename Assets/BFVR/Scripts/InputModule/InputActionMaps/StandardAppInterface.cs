...
//     version 1.2.0
//     from Assets/BFVR/Scripts/InputModule/InputActionMaps/StandardAppInterface.inputactions
//
...
{
    public partial class @StandardAppInterface : IInputActionCollection2, IDisposable
    {
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Recenter"",
            ""id"": ""2e63b285-c6da-41b1-8422-f4f8ea138667"",
            ""actions"": [
                {
                    ""name"": ""A Button"",
                    ""type"": ""Button"",
                    ""id"": ""d468612c-548d-4b5a-8d2e-e2e02b855ac9"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""62d63b45-f8a5-46b1-8dab-61357cf90b12"",
    ...
    ""controlSchemes"": []
            ...
            m_Recenter_AButton = m_Recenter.FindAction("A Button", throwIfNotFound: true);
        }
        ...
        private IRecenterActions m_RecenterActionsCallbackInterface;
        private readonly InputAction m_Recenter_AButton;
        public struct RecenterActions
        {
            private @StandardAppInterface m_Wrapper;
            public RecenterActions(@StandardAppInterface wrapper) { m_Wrapper = wrapper; }
            public InputAction @AButton => m_Wrapper.m_Recenter_AButton;
            ...
            {
                if (m_Wrapper.m_RecenterActionsCallbackInterface != null)
                {
                    @AButton.started -= m_Wrapper.m_RecenterActionsCallbackInterface.OnAButton;
                    @AButton.performed -= m_Wrapper.m_RecenterActionsCallbackInterface.OnAButton;
                    @AButton.canceled -= m_Wrapper.m_RecenterActionsCallbackInterface.OnAButton;
                }
                m_Wrapper.m_RecenterActionsCallbackInterface = instance;
                if (instance != null)
                {
